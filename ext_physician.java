...
public class ext_physician extends javax.swing.JFrame {

    private String name;
    private int nic, count=1;
    private java.sql.Date dte;
    
    public ext_physician() {
        initComponents();
        discharge_list_intable();
    }
    public void setData()
    {
        nic = Integer.parseInt(idText.getText());
        ...
        try{
            ...
            dte = java.sql.Date.valueOf(sdf.format(textDate));
        }
        catch(Exception e)
        {
    ...
    public ArrayList<extPhyClass> getPhysicainList()
    {
       ArrayList<extPhyClass> dList = new ArrayList<extPhyClass>();
       connection c =  new connection();
       Connection cn = c.getConnect();
       
       String query = " select * from ext_physician ";
       Statement st;
       ResultSet rs;
       ...
       try{
           ...
           while(rs.next())
           {
               ...
               physician = new extPhyClass(rs.getString("Docname"),
                                            rs.getDate("date"),
                       rs.getInt("NIC"),
                       rs.getInt("count")
    ...
    {
        ArrayList<extPhyClass> list = getPhysicainList();
        DefaultTableModel model =new DefaultTableModel();
        model.setColumnIdentifiers(new Object[]{"Docname","date","count","NIC"});
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("External Physician"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            //if id added only
            if (nic > 0) {
                ResultSet rs = st.executeQuery("select count(*) from ext_physician where Docname='" + this.name + "'");
                if(rs.next())
                {
                    count = rs.getInt(1)+1;
                    st.executeUpdate("insert into ext_physician(Docname, date, count, NIC) values('"+this.name+"','"+this.dte+"', '"+this.count+"','"+this.nic+"')");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        patient_attendance e = new patient_attendance();
        e.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ext_physician.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ext_physician().setVisible(true);
            }
        });
    }
